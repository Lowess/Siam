...
coups_possibles_joueur([E,R,M,e], ListeCoups) :- 	coups_possibles_pion(E, TmpCoups, [E,R,M,e]), 
							flatten(TmpCoups,ListeCoups).
coups_possibles_joueur([E,R,M,r], ListeCoups) :- 	coups_possibles_pion(R, TmpCoups, [E,R,M,r]), 
							flatten(TmpCoups,ListeCoups).
