...
%Departéplacement sur une case vide
...
oriente_pour_pousser(0, 14, n).			%	|				|
						%	|				|
						%	|				|
oriente_pour_pousser(0, 21, w).			%	|				|
oriente_pour_pousser(0, 31, w). % (2)		%	|				|
oriente_pour_pousser(0, 41, w).			%	|				|
						%   (2)	|	  PLATEAU DE JEU	| (3)
						%	|				|
oriente_pour_pousser(0, 25, s).			%	|				|
oriente_pour_pousser(0, 35, s). % (3)		%	|				|
oriente_pour_pousser(0, 45, s).			%	|				|
						%	|				|
...
%coup_possible(Plateau, (Depart,Arrivee,Orientation)) :- 
...
%%Orientationn peut pousser en entrant
